...
Semantic HTML, gives your html document a more meaningful flow. A way for people using a screeen reader to understand.

2. Name two big differences between ```display: block;``` and ```display: inline;```

    An inline element can't have width and height property set whereas a block element can. An inline element can not have top or bottom margin that can be set for a block element.
